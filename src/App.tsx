...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <main className="main">
      ...
      <footer className="app-footer"><span className="shortcut-strip"><kbd>Q</kbd><kbd>E</kbd> 피드 <span className="shortcut-separator" /><kbd>A</kbd><kbd>D</kbd> 글 <span className="shortcut-separator" /><kbd>1</kbd>–<kbd>4</kbd> 화면</span></footer>
    </main>
